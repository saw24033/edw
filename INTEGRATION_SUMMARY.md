...
### 1. scr_stations_part1.md (368 KB)
Complete wiki content for stations 1-41

### 2. scr_stations_part2.md (385 KB)
Complete wiki content for stations 42-82

**Note:** Split into 2 files to stay under 512KB per-file limit

### 3. station_knowledge_helper.py (6 KB)
Python functions to parse and query station data from both parts

### 4. custom_gpt_instructions_with_station_knowledge.txt (9 KB)
Enhanced GPT instructions using both routing + station knowledge

### 5. STATION_KNOWLEDGE_INTEGRATION_GUIDE.md (Documentation)
...
| `scr_stations_part1.md` ⭐ | 368 KB | Station wiki (1-41) |
| `scr_stations_part2.md` ⭐ | 385 KB | Station wiki (42-82) |
